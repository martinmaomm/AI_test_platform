...
export const getAPISpecifications = async (projectId, params = {}) => {
  const response = await api.get(
    `/projects/${projectId}/api-testing/api-specs/`,
    { params },
  );
...
export const deleteAPISpecification = async (projectId, id) => {
  const response = await api.delete(
    `/projects/${projectId}/api-testing/api-specs/${id}/`,
  );
  return response.data;
};
...
export const getAPIEndpoints = async (projectId, specId) => {
  const response = await api.get(
    `/projects/${projectId}/api-testing/api-specs/${specId}/endpoints/`,
  );
  return response.data;
};
...
export const getEndpointDetail = async (projectId, specId, endpointId) => {
  const response = await api.get(
    `/projects/${projectId}/api-testing/api-specs/${specId}/endpoints/${endpointId}/`,
  );
  return response.data;
};
...
export const getAPITestStatistics = async (projectId) => {
  const response = await api.get(
    `/projects/${projectId}/api-testing/statistics/`,
  );
  return response.data;
};
...
export const getAPITestCases = async (projectId, params = {}) => {
  const response = await api.get(
    `/projects/${projectId}/api-testing/test-cases/`,
    { params },
  );
  return response.data;
};
...
export const getEndpointTestCases = async (projectId, specId, endpointId) => {
  const response = await api.get(
    `/projects/${projectId}/api-testing/api-specs/${specId}/endpoints/${endpointId}/test-cases/`,
  );
  return response.data;
};
 ...
 * 入参: { case_ids: [id1, id2, id3, ...] } 按新顺序排列的用例 ID 数组
 */
export const updateEndpointTestCasesOrder = async (
  projectId,
  specId,
  endpointId,
  caseIds,
...
export const updateAPITestCase = async (projectId, id, data) => {
  const response = await api.put(
    `/projects/${projectId}/api-testing/test-cases/${id}/`,
    data,
  );
  return response.data;
};
...
export const executeAPITestCase = async (projectId, id, data = {}) => {
  const response = await api.post(
    `/projects/${projectId}/api-testing/test-cases/${id}/execute/`,
    data,
  );
  return response.data;
};
...
export const getAPITestExecutions = async (projectId, params = {}) => {
  const response = await api.get(
    `/projects/${projectId}/api-testing/executions/`,
    { params },
  );
  return response.data;
};
...
export const getAPITestExecutionReport = async (projectId, executionId) => {
  const response = await api.get(
    `/projects/${projectId}/api-testing/executions/${executionId}/report/`,
  );
  return response.data;
};
...
export const getAPITestCaseExecutionDetail = async (projectId, executionId) => {
  const response = await api.get(
    `/projects/${projectId}/api-testing/executions/case/${executionId}/`,
  );
  return response.data;
};

// 获取套件执行详情
export const getAPITestSuiteExecutionDetail = async (
  projectId,
  executionId,
) => {
  const response = await api.get(
    `/projects/${projectId}/api-testing/executions/suite/${executionId}/`,
  );
  return response.data;
};
...
export const getAPITestExecutionCases = async (projectId, executionId) => {
  const response = await api.get(
    `/projects/${projectId}/api-testing/executions/${executionId}/cases/`,
  );
  return response.data;
};
...
export const deleteAPITestExecution = async (projectId, executionId) => {
  const response = await api.delete(
    `/projects/${projectId}/api-testing/executions/${executionId}/delete/`,
  );
  return response.data;
};
...
export const getAPITestSuites = async (projectId, params = {}) => {
  const response = await api.get(
    `/projects/${projectId}/api-testing/test-suites/`,
    { params },
  );
  return response.data;
};
...
export const getAPITestSuite = async (projectId, id) => {
  const response = await api.get(
    `/projects/${projectId}/api-testing/test-suites/${id}/`,
  );
  return response.data;
};
...
// 从套件移除测试用例
export const removeTestCaseFromSuite = async (
  projectId,
  suiteId,
  testCaseId,
) => {
  const response = await api.delete(
    `/projects/${projectId}/api-testing/test-suites/${suiteId}/remove-test-case/${testCaseId}/`,
  );
  return response.data;
};
...
export const executeAPITestSuite = async (projectId, suiteId, data = {}) => {
  const response = await api.post(
    `/projects/${projectId}/api-testing/test-suites/${suiteId}/execute/`,
    data,
  );
  return response.data;
};
...
export const getTaskStatus = async (projectId, taskId) => {
  const response = await api.get(
    `/projects/${projectId}/api-testing/task-status/${taskId}/`,
  );
  return response.data;
};
