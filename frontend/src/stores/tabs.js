...
const ROUTE_TITLE_MAP = {
  ...
  '/perf-testing/projects': '性能测试项目列表',
  '/perf-testing/workspace': '压测计划',
  '/perf-testing/plans': '压测计划',
  '/perf-testing/nodes': '节点管理',
  '/perf-testing/targets': '压测目标',
