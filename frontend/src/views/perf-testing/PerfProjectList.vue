<template>
  <div class="page-wrapper">
    <div class="main-content">
      <el-page-header content="性能专项测试项目列表" class="page-header">
        <template #icon>
      ...
      <div v-loading="loading" class="projects-content">
        <el-empty v-if="!loading && projectList.length === 0" description="暂无性能专项测试项目" />
      ...
      <el-dialog v-model="showCreateDialog" title="新建性能项目" width="500px" :close-on-click-modal="false" @close="resetCreateForm">
...
// 加载项目列表（严格携带 project_type: 'perf'）
const loadProjects = async () => {
  loading.value = true
  try {
    const response = await getProjects({ project_type: 'perf' })
