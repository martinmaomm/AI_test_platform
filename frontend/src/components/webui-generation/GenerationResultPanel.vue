...
const props = defineProps({ generation: { type: Object, default: null }, draft: { type: Object, default: null }, saving: Boolean, resolving: Boolean, draftSaving: Boolean, debugging: Boolean, repairing: Boolean, repairApplying: Boolean, repairDiscarding: Boolean, busy: Boolean, repairBusy: Boolean, draftConflict: Boolean, debugExecution: { type: Object, default: null }, debugExecutionLoading: Boolean, repairExecution: { type: Object, default: null }, repairExecutionLoading: Boolean, selectedRepairExecutionId: { type: [Number, String], default: null } })
const emit = defineEmits(['resolve', 'cancel', 'save', 'open-test-case', 'update-draft', 'save-draft', 'debug', 'repair', 'apply-repair', 'discard-repair', 'view-repair-execution', 'retry-generation', 'discard-local-draft'])
