...
const ROUTE_TITLE_MAP = {
  ...
  '/web-testing/create': '智能创建',
  '/web-testing/create/requirements': '智能创建',
  '/web-testing/create/explore': '智能创建',
  '/web-testing/test-case-generator': '智能创建',
  '/web-testing/webui-auto-test': '智能创建',
