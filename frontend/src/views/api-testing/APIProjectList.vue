<template>
  <div class="page-wrapper">
    <div class="main-content">
      <!-- 精美 PageHeader -->
      <el-page-header content="API 测试项目列表" class="page-header">
        <template #icon>
      ...
      <div v-loading="loading" class="projects-content">
        <el-empty v-if="!loading && projectList.length === 0" description="暂无 API 测试项目" />
            ...
            <el-card shadow="hover" class="project-card">
              ...
              <div class="card-footer">
                ...
                <div class="footer-actions">
                  <el-button type="warning" size="small" @click="openEditDialog(project)">
                    编辑
                  </el-button>
...
// 加载项目列表（严格携带 project_type: 'api'）
const loadProjects = async () => {
  loading.value = true
  try {
    const response = await getProjects({ project_type: 'api' })
...
const enterProject = async (project) => {
  try {
    ...
    router.push('/api-testing/function-navigation')
  } catch {
...
/* 隐藏 el-page-header 默认的「返回」标题，避免与 BackButton 重复 */
